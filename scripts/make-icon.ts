...
<svg xmlns="http://www.w3.org/2000/svg" width="${SIZE}" height="${SIZE}" viewBox="0 0 1024 1024">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0" stop-color="#ece4cd"/>
      <stop offset="1" stop-color="#d9cda9"/>
    </linearGradient>
  </defs>
  <rect width="1024" height="1024" rx="200" fill="url(#bg)"/>
  <rect x="70" y="70" width="884" height="884" rx="150" fill="none" stroke="#b7a97e" stroke-width="10"/>
  <g transform="translate(80 71) scale(18)">
    <path d="M12 4 L18 12 L24 10 L30 12 L36 4 L38 16 L40 25 L32 37 L24 45 L16 37 L8 25 L10 16 Z"
          fill="#5c6b33" opacity="0.14"/>
    <path d="M12 4 L18 12 L24 10 L30 12 L36 4 L38 16 L40 25 L32 37 L24 45 L16 37 L8 25 L10 16 Z"
          fill="none" stroke="#55642f" stroke-width="2" stroke-linejoin="round"/>
    <path d="M15 22 L21 25 M33 22 L27 25"
          fill="none" stroke="#55642f" stroke-width="2" stroke-linecap="round"/>
    <path d="M21 33 L27 33 L24 37 Z"
          fill="#55642f" stroke="#55642f" stroke-width="1.5" stroke-linejoin="round"/>
  </g>
</svg>`;
